DROP TABLE IF EXISTS bx_menber;
CREATE TABLE bx_menber(
...
INSERT INTO bx_menber (`username`, `password`, `power`,`salt`,`boss_id`,`software_id`) VALUES
 ('admin','a66abb5684c45962d887564f08346e8d','1','123456','1','');
...
DROP TABLE IF EXISTS bx_card_type;
CREATE TABLE bx_card_type(
id int auto_increment,
...
DROP TABLE IF EXISTS bx_card;
CREATE TABLE bx_card(
id int auto_increment,
software_id int NOT NULL,
...
DROP TABLE IF EXISTS bx_config;
CREATE TABLE bx_config(
k varchar(255) NOT NULL default '',
v text NOT NULL,
PRIMARY KEY(k)
) ENGINE = MyISAM CHARSET=utf8;
INSERT INTO bx_config VALUES ('sitename','冰心网络验证');
INSERT INTO bx_config VALUES ('table_num','30');
INSERT INTO bx_config VALUES ('agent_bulletin','
...
');
INSERT INTO bx_config VALUES ('template_admin','default');
INSERT INTO bx_config VALUES ('template_agent','default');
...
DROP TABLE IF EXISTS bx_menber_log;
CREATE TABLE bx_menber_log(
id int auto_increment,
...
DROP TABLE IF EXISTS bx_user_log;
CREATE TABLE bx_user_log(
id int auto_increment,
...
DROP TABLE IF EXISTS bx_recharge_log;
CREATE TABLE bx_recharge_log(
id int auto_increment,
user_id int NOT NULL,
software_id int NOT NULL,
menber_id int NOT NULL,
...
DROP TABLE IF EXISTS bx_agent_authority;
CREATE TABLE bx_agent_authority(
id int auto_increment,
menber_id int NOT NULL,
...
DROP TABLE IF EXISTS bx_agent_card;
CREATE TABLE bx_agent_card(
id int auto_increment,
cardnum varchar(300) NOT NULL,
name varchar(50) NOT NULL,
money decimal(12,2) NOT NULL,
...
DROP TABLE IF EXISTS bx_template;
CREATE TABLE bx_template(
id int auto_increment,
...
INSERT INTO bx_template (`name`, `directory`, `author`,`author_url`,`version`,`description`) VALUES 
('默认模版','default','BingXin','http://wlyz.bingxs.com/','1.0','简洁优雅');

DROP TABLE IF EXISTS bx_plugin;
CREATE TABLE bx_plugin(
id int auto_increment,
name varchar(50) NOT NULL default '',
directory varchar(255) NOT NULL default '',
state tinyint NOT NULL default '1',
...
DROP TABLE IF EXISTS bx_single_card;
CREATE TABLE bx_single_card(
id int auto_increment,
software_id int NOT NULL,
cardnum varchar(300) NOT NULL,
name varchar(50) NOT NULL,
...
DROP TABLE IF EXISTS bx_black;
CREATE TABLE bx_black(
id int auto_increment,
